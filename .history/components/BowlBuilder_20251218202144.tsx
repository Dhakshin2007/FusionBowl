    ...
    <section id={SectionId.BUILDER} className="py-24 bg-brand-cream dark:bg-brand-dark min-h-screen">
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-gray-500 max-w-lg mx-auto mb-12 text-sm md:text-base">Elevate your experience with your own customization. Select your pack and curate each compartment with handpicked fruits.</p>
