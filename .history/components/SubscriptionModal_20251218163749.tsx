                        ...
                        <div className="grid grid-cols-1 gap-4">
                          {(['Mini', 'Compact', 'Grand'] as PlanSize[]).map((s) => (
                            ...
                            >
                              ...
                              <div className={`w-8 h-8 rounded-full border-2 flex items-center justify-center transition-all ${size === s ? 'bg-white text-brand-green border-white scale-110 shadow-lg' : 'border--100 dark:border-neutral-800'}`}>
