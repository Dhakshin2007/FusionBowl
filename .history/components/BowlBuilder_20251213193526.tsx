            ...
            <div className="bg-white dark:bg-neutral-900 rounded-3xl shadow-xl border border-gray-100 dark:border-neutral-800 p-6 md:p-10 relative overflow-hidden">
                ...
                <div className="flex justify-center mb-8 relative z-20">
                    ...
                    >
                        ...
                        <div className="absolute inset-0 bg-gradient-to-br from-transparent to-black/5 dark:to-black/20 rounded-full pointer-events-none" />
                            ...
                            {selectedIngredients.map((item, index) => {
                                ...
                                return (
                                    <motion.div
                                        ...
                                        className="absolute text-4xl md:text-5xl cursor-grab select-none drop-shadow-md hover:scale-110 transition-transform z-10"
                                    >
                                        {item.item.emoji}
                                    </motion.div>
                                );
