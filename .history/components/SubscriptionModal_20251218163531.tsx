                          ...
                          {(['Mini', 'Compact', 'Grand'] as PlanSize[]).map((s) => (
                            <button
                              ...
                              className={`p-6 rounded-[2rem] font-bold transition-all border-2 text-left flex justify-between items-center group ${size === s
                                ? 'bg-brand-orange border-brand-orange text-white shadow-xl shadow-orange-500/10'
                                : 'bg-white dark:bg-neutral-900 border-gray-100 dark:border-neutral-800 text-gray-500 hover:border-brand-orange/30'
                                }`}
                            >
                              ...
                              <div className={`w-8 h-8 rounded-full border-2 flex items-center justify-center transition-all ${size === s ? 'bg-white text-brand-orange border-white scale-110 shadow-lg' : 'border-gray-100 dark:border-neutral-800'}`}>
