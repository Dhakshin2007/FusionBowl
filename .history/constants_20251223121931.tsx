import { Ingredient, Service, FAQItem, Product } from './types';
...
export const NAV_LINKS = [
  ...
  { name: 'Menu', href: '#menu' },
  { name: 'Our Shop', href: '?page=shop', isExternal: true },
...
export const SHOP_PRODUCTS: Product[] = [
  // Basic Fruits
  { id: 'bp-mosambi', name: 'Mosambi (బత్తాయి)', category: 'Basic Fruits', price: 60, unit: 'kg', emoji: '🍋', image: 'https://picsum.photos/seed/mosambi/400/300' },
  { id: 'bp-papaya', name: 'Papaya (బొప్పాయి)', category: 'Basic Fruits', price: 40, unit: 'kg', emoji: '🧡', image: 'https://picsum.photos/seed/papaya/400/300' },
  { id: 'bp-watermelon', name: 'Watermelon (పుచ్చకాయ)', category: 'Basic Fruits', price: 30, unit: 'kg', emoji: '🍉', image: 'https://picsum.photos/seed/watermelon/400/300' },
  { id: 'bp-guava', name: 'Guava (జామకాయ)', category: 'Basic Fruits', price: 80, unit: 'kg', emoji: '🍏', image: 'https://picsum.photos/seed/guava/400/300' },
  { id: 'bp-orange', name: 'Orange (నారింజ)', category: 'Basic Fruits', price: 120, unit: 'kg', emoji: '🍊', image: 'https://picsum.photos/seed/orange/400/300' },
  
  // Premium Fruits
  { id: 'pp-pomegranate', name: 'Pomegranate (దానిమ్మ)', category: 'Premium Fruits', price: 180, unit: 'kg', emoji: '🔴', image: 'https://picsum.photos/seed/pomegranate/400/300' },
  { id: 'pp-apple', name: 'Apple (ఆపిల్)', category: 'Premium Fruits', price: 220, unit: 'kg', emoji: '🍎', image: 'https://picsum.photos/seed/apple/400/300' },
  { id: 'pp-dragon-fruit', name: 'Dragon Fruit', category: 'Premium Fruits', price: 150, unit: 'unit', emoji: '🍥', image: 'https://picsum.photos/seed/dragon/400/300' },
  
  // Exotic Fruits
  { id: 'ep-kiwi', name: 'Kiwi (కివీ)', category: 'Exotic Fruits', price: 45, unit: 'unit', emoji: '🥝', image: 'https://picsum.photos/seed/kiwi/400/300' },
  { id: 'ep-avocado', name: 'Avocado (అవకాడో)', category: 'Exotic Fruits', price: 180, unit: 'unit', emoji: '🥑', image: 'https://picsum.photos/seed/avocado/400/300' },
  { id: 'ep-strawberry', name: 'Strawberry (స్ట్రాబెర్రీ)', category: 'Exotic Fruits', price: 150, unit: 'box', emoji: '🍓', image: 'https://picsum.photos/seed/strawberry/400/300' },
  
  // Dry Fruits
  { id: 'df-almonds', name: 'Almonds (బాదం)', category: 'Dry Fruits', price: 450, unit: '500g', emoji: '🥜', image: 'https://picsum.photos/seed/almonds/400/300' },
  { id: 'df-cashew', name: 'Cashew (జీడిపప్పు)', category: 'Dry Fruits', price: 500, unit: '500g', emoji: '🥜', image: 'https://picsum.photos/seed/cashew/400/300' },
  { id: 'df-dates', name: 'Kimia Dates (ఖర్జూరం)', category: 'Dry Fruits', price: 280, unit: 'box', emoji: '🌴', image: 'https://picsum.photos/seed/dates/400/300' },

  // Juices
  ...INGREDIENTS.filter(i => i.category === 'shake-item').map(j => ({
    id: j.id,
    name: j.name,
    ...
    unit: 'Bottle (360ml)',
    emoji: j.emoji,
    image: `https://picsum.photos/seed/${j.id}/400/300`
  }))
];
