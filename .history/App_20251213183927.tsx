...
import { Truck, MapPin, Clock, Phone, Mail, Instagram, Facebook, Code } from 'lucide-react';
  ...
  return (
    <div className="font-sans text-gray-800 dark:text-gray-200 transition-colors duration-300">
      ...
      <main>
        ...
        {/* Brand Story Section */}
        <section id={SectionId.STORY} className="py-24 bg-white dark:bg-brand-dark transition-colors duration-300">
            ...
            <div className="flex flex-col md:flex-row items-center gap-16">
              ...
              <div className="md:w-1/2 space-y-6">
                ...
                <p className="text-lg text-gray-600 dark:text-gray-400 leading-relaxed">
                  Fusion Bowl started with a simple question: "Why is healthy food so boring?" 
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {SERVICES.map((service, index) => (
                <motion.div
                  ...
                  className="bg-white dark:bg-neutral-800 p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 dark:border-neutral-700 flex flex-col items-start group"
                >
                  <div className="w-14 h-14 bg-orange-50 dark:bg-orange-900/20 rounded-xl flex items-center justify-center text-brand-orange mb-6 group-hover:bg-brand-orange group-hover:text-white transition-colors duration-300">
                    <span className="text-2xl font-bold">{index + 1}</span>
                  </div>
                  <h3 className="text-2xl font-serif font-bold mb-3 text-gray-900 dark:text-brand-cream">{service.title}</h3>
        ...
        <section id={SectionId.TESTIMONIALS} className="py-24 bg-brand-dark dark:bg-neutral-950 text-white transition-colors duration-300">
          <div className="container mx-auto px-6">
            <h2 className="text-4xl font-serif font-bold text-center mb-16 text-brand-cream">Community Love</h2>
            <div className="grid md:grid-cols-3 gap-8">
              {TESTIMONIALS.map((t, i) => (
                <div key={i} className="bg-white/5 p-8 rounded-2xl backdrop-blur-sm border border-white/10 hover:bg-white/10 transition-colors">
        ...
        <section className="py-20 bg-white dark:bg-brand-dark transition-colors duration-300">
          <div className="container mx-auto px-6 text-center">
            <div className="max-w-4xl mx-auto bg-green-50 dark:bg-green-900/10 rounded-3xl p-8 md:p-12 border border-green-100 dark:border-green-900/30">
      ...
      {/* Footer */}
      <footer className="bg-gray-50 dark:bg-neutral-900 border-t border-gray-200 dark:border-neutral-800 pt-16 pb-8 transition-colors duration-300">
        <div className="container mx-auto px-6">
