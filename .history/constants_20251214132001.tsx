...
export const INGREDIENTS: Ingredient[] = [
  ...
  { id: 'juice-watermelon', name: 'Watermelon (Pure)', category: 'shake-item', price: 80, calories: 90, color: 'bg-red-400', emoji: '🍉' },
  { id: 'juice-beetroot', name: 'Beetroot (Red-Revive)', category: 'shake-item', price: 80, calories: 80, color: 'bg-pink-800', emoji: '🟣' },
  { id: 'juice-mango', name: 'Mango (Golden Summer)', category: 'shake-item', price: 90, calories: 150, color: 'bg-yellow-500', emoji: '🥭' },
  { id: 'juice-pineapple', name: 'Pineapple (Bliss)', category: 'shake-item', price: 100, calories: 120, color: 'bg-yellow-400', emoji: '🍍' },
  { id: 'juice-muskmelon', name: 'Muskmelon (Golden)', category: 'shake-item', price: 100, calories: 100, color: 'bg-orange-200', emoji: '🍈' },
  { id: 'juice-carrot', name: 'Carrot (Powerhouse)', category: 'shake-item', price: 110, calories: 95, color: 'bg-orange-600', emoji: '🥕' },
  { id: 'juice-abc', name: 'ABC (Apple Beetroot Carrot)', category: 'shake-item', price: 130, calories: 110, color: 'bg-red-700', emoji: '🥤' },
  { id: 'juice-apple', name: 'Apple (Solutely Healthy)', category: 'shake-item', price: 130, calories: 120, color: 'bg-red-500', emoji: '🍎' },
  { id: 'juice-pomegranate', name: 'Pomegranate (Punch)', category: 'shake-item', price: 150, calories: 140, color: 'bg-red-800', emoji: '🔴' },
];
