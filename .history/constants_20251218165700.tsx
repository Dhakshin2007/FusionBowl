...
{ name: 'Pink Dragon (పింక్ డ్రాగన్ ఫ్రూట్)', emoji: '' },
{ name: 'White Dragon (వైట్ డ్రాగన్ ఫ్రూట్)', emoji: '' }
...
export const SIGNATURE_BOWLS = [
  {
    id: 'morning-glow',
    name: 'Sprout Salad',
    ingredients: 'Green Moong, Red Chowli, Chana, Peanuts, Cherry Tomatoes, Spring Onions, Cabbage, Coriander Leaves, Cucumber, Onion, Ginger, Salt, Chat Masala, Lemon & Olive Oil Dressingg',
    price: 180,
    calories: 250,
    tag: 'Best Seller'
  },
