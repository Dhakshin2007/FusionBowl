            ...
            <div className="flex flex-col md:flex-row items-center gap-16">
              ...
              >
                ...
                <p className="text-lg text-gray-600 dark:text-gray-400 leading-relaxed">
                  Fusion Bowl started with a simple question in the young minds of an enthusiastic team: “Why is healthy food so boring?”
                  We believe that eating fresh shouldn't feel like a chore. It should be colorful, textural, and deeply satisfying.
                </p>
                <p className="text-lg text-gray-600 dark:text-gray-400 leading-relaxed">
                  Located in the heart of NRT, we source our produce daily at 4 AM to ensure that when you customize your bowl at 10 PM, it's as fresh as nature intended.
                </p>
            ...
            <div>
              ...
              <div className="mt-6 pt-6 border-t border-gray-200 dark:border-neutral-800">
                ...
                <div className="text-sm text-gray-600 dark:text-gray-400 space-y-1">
                  <p><span className="font-medium text-gray-700 dark:text-gray-300">Mrng:</span> 6:00 AM - 10:30 AM</p>
