...
import FloatingWhatsApp from './components/FloatingWhatAapp';
import { SERVICES, TESTIMONIALS } from './constants';
import { SectionId } from './types';
import Button from './components/Button';
import { motion } from 'framer-motion';
import { Truck, MapPin, Clock, Phone, Mail, Instagram, Facebook, Code, CalendarHeart, Box, ChefHat } from 'lucide-react';
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {SERVICES.map((service, index) => (
                <motion.div
                  ...
                  className="bg-white dark:bg-neutral-800 p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 dark:border-neutral-700 flex flex-col items-center text-center group transform hover:-translate-y-3"
                >
          ...
          <div className="container mx-auto px-6">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {TESTIMONIALS.map((t, i) => (
                <div key={i} className="bg-white/5 p-8 rounded-2xl backdrop-blur-sm border border-white/10 hover:bg-white/10 hover:-translate-y-2 transition-all duration-300">
